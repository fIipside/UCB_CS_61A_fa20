...
![ 2024-08-16 171207.png](https://s2.loli.net/2024/08/16/ZO6X3NwsQoz2lpv.png)
### Choosing Names
-  Names typically don’t matter for correctness but they matter a lot for composition.

![ 2024-08-16 174206.png](https://s2.loli.net/2024/08/16/aCgc2vuQsP4pRXz.png)
### Which Values Deserve a Name
![ 2024-08-16 182631.png](https://s2.loli.net/2024/08/16/rPsK6Mqpkwy1NgG.png)
## Function Example: Sounds
### WAV Files
![ 2024-08-16 182916.png](https://s2.loli.net/2024/08/16/VwfenAOoxDWYN2T.png)
```py
# demo
...
def note(f, start, end, fade=.01):
    """Play f for a fixed duration. Not that harsh."""
    def sampler(t):
        seconds = t / frame_rate
        if seconds < start:
            return 0
